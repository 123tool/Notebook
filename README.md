...
- **Realtime Sync:** Ketik di satu perangkat, muncul di seluruh dunia dalam < 1 detik.

## 🛠️ Dev Setup
1. Ganti `firebaseConfig` di `index.html` dengan API Key kamu sendiri (Jangan jadi noob dengan pakai punya saya).
2. Deploy ke Firebase Hosting atau Vercel.
3. Profit.

**CREATOR:** [SPY-E // AI7 STUDIO]
